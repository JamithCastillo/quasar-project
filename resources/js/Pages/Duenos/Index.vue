  ...
  <Layout>
    ...
    <div class="py-8 w-10/12 ">
      ...
      <div
        ...
        >
          <Link
          :href="route('duenos.create')" 
            title="Crear un nuevo Dueños"
...
$(document).on("click","#edit", function(){
    ...
    Swal.fire({
    title: '¿Desea eliminar el dueño '+$(this).data('id')+'? ',
    icon: 'question',
