...
const mensajeimp21 = ref()
const mensajeimp10 = ref()
const mensajeimp4 = ref()
...
const submit = () => {
  ...
  form.post('/perros', { preserveScroll: true })
}
